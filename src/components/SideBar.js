...
function SideBar() {
  ...
  React.useEffect(() => {
    ...
    if (currentMode) {
      setDarkMode(true);
      document.querySelector('.theme-box__sun').classList.add('theme-box--active');
    } else {
      setDarkMode(false);
      document.querySelector('.theme-box__sun').classList.add('theme-box--active');
    }
  ...
  React.useEffect(() => {
    document.querySelector('.theme-box__moon').classList.toggle('theme-box--active');
    document.querySelector('.theme-box__sun').classList.toggle('theme-box--active');
    if (darkMode) {
